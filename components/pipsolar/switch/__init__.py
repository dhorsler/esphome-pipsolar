...
CONF_CHARGER_SOURCE_PRIORITY_UTIL_ONLY = "charger_source_priority_util_only"
CONF_CHARGER_SOURCE_PRIORITY_SOLAR_FIRST = "charger_source_priority_solar_first"
CONF_CHARGER_SOURCE_PRIORITY_SOLAR_UTIL = "charger_source_priority_solar_util"
...
TYPES = {
    ...
    CONF_CHARGER_SOURCE_PRIORITY_UTIL_ONLY: ("PCP00", None),
    CONF_CHARGER_SOURCE_PRIORITY_SOLAR_FIRST: ("PCP01", None),
    CONF_CHARGER_SOURCE_PRIORITY_SOLAR_UTIL: ("PCP02", None),
